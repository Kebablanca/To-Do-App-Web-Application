<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterPage.aspx.cs" Inherits="halit.RegisterPage" Async="true" %>
...
<body>
    ...
    <asp:TextBox runat="server" ID="NameTextBox" placeholder="Ad girin"></asp:TextBox>
</div>
                    <div class="input-field">
                        <asp:Label runat="server" AssociatedControlID="SurnameTextBox">Surname</asp:Label>
                        <asp:TextBox runat="server" ID="SurnameTextBox" placeholder="Soyad girin"></asp:TextBox>
                    </div>
                    <div class="input-field">
